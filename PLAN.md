...
- [ ] Membership-guard helper for workspace-scoped queries (the isolation foundation)
...
- [ ] Branding applied across login, app chrome, share pages, and all email templates; "Powered by BragBit" footer on share pages
- [ ] Personal-workspace UX: hide member/invite/role chrome; expose profile + light personalization (display name, avatar, optional accent) — useful for a freelancer's client-facing share pages
