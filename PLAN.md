...
> per-brag visibility toggle), 6.2 (the owner-side create/revoke/rotate actions +
> the share dialog + copy-link UX), 6.3 (the public `/share/[token]` view with
> visibility filtered at the query layer), and 6.4 (optional argon2 passwords) are
> done and committed. Next: the security tests (6.5).
